...
/**
 ...
 also have a parent entity. It may be null (there's no parent for the entity).
...
public:
	...
	virtual bool remove(const std::pair<std::string,std::string> & nameValue, bool removeParent = false) = 0;
